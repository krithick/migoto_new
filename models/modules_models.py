...
# Import ContentVisibility from course_models to maintain consistency
...
class ModuleDB(ModuleBase):
    ...
    company_id: UUID                                          # Which company owns this module
    visibility: ContentVisibility = ContentVisibility.CREATOR_ONLY  # Who can assign this module
