...
#     PersonaBase, PersonaCreate, PersonaResponse, PersonaDB,
#     PersonaGenerateRequest,  UserRole
# )
...
#     if persona_dict.get("_id") is None:
#         persona_dict.pop("_id", None)
#     else:
#         persona_dict["_id"] = UUID(str(persona_dict["_id"]))
    
#     result = await db.personas.insert_one(persona_dict)
#     created_persona = await db.personas.find_one({"_id": result.inserted_id})
...
#         if persona.get("created_by") != updated_by:
#             raise HTTPException(
...
#     updated_persona = await db.personas.find_one({"_id": persona_id})
#     if updated_persona:
...
#         if persona.get("created_by") != deleted_by:
#             raise HTTPException(
#                 status_code=status.HTTP_403_FORBIDDEN,
...
#     # Check if this persona is being used in any avatar interactions
