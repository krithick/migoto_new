...
function AvatarVoice({ data,currentPage, alreadyPlaying, setAlreadyPlaying, currentPlaying, setCurrentPlaying}) {
  ...
  return (
    <div className={styles.voiceCardContainer} onClick={()=>{handleSelectData()}}>
