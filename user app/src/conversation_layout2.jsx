...
const ConversationLayout2 = () => {
  ...
  const Request_to_WitAI_for_TTS = async (props) => {
    ...
    try {
      ...
      Ensures we get binary audio data
      });
  ...
  return (
    <div className="absolute inset-0 backdrop-blur-[68px]">
      <div className="h-screen w-screen relative">
        <HeaderMenu />
        <div className="h-[35.5rem] xl:h-[37rem] 2xl:h-[56rem] w-screen flex items-center">
          <div className="h-full w-screen place-content-center px-[10rem] xl:px-[9.5rem] 2xl:px-[10rem] pb-[5rem]">
            ...
            <div className="h-full w-full bg-[#ffffff80] rounded-l-[30px] rounded-r-[10px] flex">
              ...
              >
                ...
                <div className="h-[40.8rem] xl:h-[26rem] 2xl:h-[40.8rem] w-full px-[3.5rem] xl:px-[2rem] 2xl:px-[3.5rem] py-[15px] xl:py-[px] 2xl:py-[15px]">
                  <div className="h-full w-full flex justify-center items-center gap-x-[5rem] xl:gap-x-[2.5rem] 2xl:gap-x-[5rem] overflow-y-auto [&::-webkit-scrollbar]:w-[6px] [&::-webkit-scrollbar-track]:bg-[#d3e4ebef] [&::-webkit-scrollbar-thumb]:bg-[#3E4580] [&::-webkit-scrollbar-track]:rounded-[22px] [&::-webkit-scrollbar-thumb]:rounded-[22px]">
                    ...
                    <div className="h-[28rem] xl:h-[23.5rem] 2xl:h-[39rem] w-full relative">
                      <div className="absolute inset-0 h-full w-full">
                        <img
                          src="./Environment/environment.png"
                          loading="lazy"
                          alt=""
                      ...
                      <div className="absolute inset-y-0 right-0 px-3 place-content-center">
                        <div className="h-[35rem] xl:h-[22.5rem] 2xl:h-[35rem] w-[25rem] xl:w-[15rem] 2xl:w-[22rem] rounded-[10px] bg-[#FFFFFF8F]">
                          ...
                          <div className="h-[28rem] xl:h-[16rem] 2xl:h-[28rem] w-full flex justify-center items-center">
                          ...
                          <div className="h-[4rem] w-full bg-[#131f4998] rounded-b-[10px] flex justify-between items-center px-3.5 xl:px-0.5 2xl:px-2 py-1 xl:py-0">
