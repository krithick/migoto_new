        ...
        <div className="h-[35.5rem] xl:h-[37rem] 2xl:h-[56rem] w-screen flex items-center">
          <div className="h-full w-screen place-content-center px-[10rem] xl:px-[7.5rem] 2xl:px-[10rem] pb-[5rem]">
            ...
            <div className="h-full w-full bg-[#ffffff80] rounded-l-[30px] rounded-r-[10px] flex">
              <div
                className={`transition-all duration-700 ease-in-out h-full w-[80rem] ${
                  close
                  ...
                  <div className="h-full w-full flex justify-center items-center gap-x-[5rem] xl:gap-x-[2.5rem] 2xl:gap-x-[5rem] overflow-y-auto [&::-webkit-scrollbar]:w-[6px] [&::-webkit-scrollbar-track]:bg-[#d3e4ebef] [&::-webkit-scrollbar-thumb]:bg-[#3E4580] [&::-webkit-scrollbar-track]:rounded-[22px] [&::-webkit-scrollbar-thumb]:rounded-[22px]">
                    ...
                    <div className="h-[28rem] xl:h-[23.5rem] 2xl:h-[39rem] w-full relative">
                      <div className="absolute inset-0 h-full w-full">
                        <img
                          src="./Environment/Interior1_002.jpg"
                          loading="lazy"
                          alt="interior"
                              ...
                              {recording ? (
                                ...
                                >
                                  {({ canvasRef }) => (
                                    <canvas
                                      ref={canvasRef}
                                      className="h-12 w-64 bg-[#f2f2f22f] rounded"
                                    />
                                  )}
                                </Visualizer>
                              ) : (
                                <input
                                  ...
                                  className="w-64 py-2 px-1.5 bg-[#C7DFF09C] rounded-[5px] text-[12px] focus:outline-none text-[#131F49]"
                                />
                              )}
                            </div>
                            <div className="text-center -space-y-1.5">
