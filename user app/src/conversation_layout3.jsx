        ...
        <div className="h-[35.5rem] xl:h-[37rem] 2xl:h-[56rem] w-screen flex items-center">
          <div className="h-full w-screen place-content-center px-[10rem] xl:px-[9.5rem] 2xl:px-[10rem] pb-[5rem]">
            ...
            <div className="h-full w-full bg-[#ffffff80] rounded-l-[30px] rounded-r-[10px] flex">
              <div
                className={`transition-all duration-1000 ease-in-out animate-fade-left animate-ease-linear h-full w-[80rem] ${
                  close
                    ? "xl:w-[70rem] 2xl:w-[100rem]"
                    : "xl:w-[70rem] 2xl:w-[80rem]"
                }`}
              >
                ...
                <div className="h-[40.8rem] xl:h-[26rem] 2xl:h-[40.8rem] w-full px-[3.5rem] xl:px-[2rem] 2xl:px-[3.5rem] py-[15px] xl:py-[px] 2xl:py-[15px]">
                  <div className="h-full w-full grid grid-cols-3 place-content-center gap-x-[5rem] xl:gap-x-0 2xl:gap-x-[1rem] overflow-y-auto [&::-webkit-scrollbar]:w-[6px] [&::-webkit-scrollbar-track]:bg-[#d3e4ebef] [&::-webkit-scrollbar-thumb]:bg-[#3E4580] [&::-webkit-scrollbar-track]:rounded-[22px] [&::-webkit-scrollbar-thumb]:rounded-[22px]">
                    ...
                    <div className="col-span-1 h-full w-full place-items-center">
                      <div
                        className={`h-[35rem] xl:h-[24rem] 2xl:h-[35rem]  bg-[#FFFFFF8F] rounded-[10px] transition-all duration-1000 ease-in-out animate-fade-left animate-ease-linear ${
                          close
                      ...
                      >
                        ...
                        <div className="h-[28rem] xl:h-[21.5rem] 2xl:h-[32rem] w-full relative">
                          <Webcam
                            ...
                            //   width={1280}
                            mirrored={true}
                            className={`transition-all duration-700 ease-in-out w-full object-cover rounded-b-[10px] ${
                              !cameraToggle ? "h-full block" : "h-0 hidden"
                            }`}
                          />
                        </div>
                      </div>
                    ...
                    <div className="col-span-1 h-full w-full place-items-center">
                      ...
                      >
                        ...
                        <div className="h-[28rem] xl:h-[17.5rem] 2xl:h-[28rem] w-full flex justify-center items-center pr-2 py-1.5">
                          {/* Conversation Dialog */}
                        ...
                        <div className="h-[4rem] w-full bg-[#131f4998] rounded-b-[10px] flex justify-between items-center px-3 py-1">
                          ...
                          <div>
                            {recording ? (
                              ...
                              <input
                                ...
                                className="w-60 xl:w-40 2xl:w-60 h-auto py-2 px-1.5 bg-[#C7DFF09C] rounded-[5px] text-[12px] font-600 focus:outline-none text-[#131F49]"
                              />
                            )}
                          </div>
                          <div className="text-center -space-y-1.5">
