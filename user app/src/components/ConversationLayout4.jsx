...
const ConversationLayout4 = ({
  ...
  // const glbfiles = [
  //   "/Character/Moh_Beard_Br2.glb",
  //   "/Character/Moh_Body_B1.glb",
  //   "/Character/Moh_Pant_Pt2.glb",
  //   "/Character/Moh_Shirt_St2.glb",
  //   "/Character/Moh_Hair_Hr2.glb",
  // ];

  // const glbfiles = [
  //   "/Character/Moh_Glass_Gls2.glb",
  //   "/Character/Moh_Beard_Br1.glb",
  //   "/Character/Moh_Body_B1.glb",
  //   "/Character/Moh_Pant_Pt3.glb",
  //   "/Character/Moh_Shirt_St3.glb",
  //   "/Character/Moh_Hair_Hr3.glb",
  // ];

  // "/Character/Moh_Beard_Br1.glb",
  // const glbfiles = [
  //   "/Character/Moh_Body_B1.glb",
  //   "/Character/Moh_Pant_Pt4.glb",
  //   "/Character/Moh_Shirt_St4.glb",
  //   "/Character/Moh_Hair_Hr1.glb",
  // ];
  ...
  // const glbfiles = [
  //   "/Character/Ama_Body_B1.glb",
  //   "/Character/Ama_Glass_Gls2.glb",
  //   "/Character/Ama_Pant_Pt2.glb",
  //   "/Character/Ama_Shirt_St2.glb",
  //   "/Character/Ama_Hair_Hr2.glb",
  // ];

  // const glbfiles = [
  //   "/Character/Ama_Body_B1.glb",
  //   "/Character/Ama_Pant_Pt3.glb",
  //   "/Character/Ama_Shirt_St3.glb",
  //   "/Character/Ama_Hair_Hr3.glb",
  // ];

  // const glbfiles = [
  //   "/Character/Ama_Body_B1.glb",
  //   "/Character/Ama_Pant_Pt4.glb",
  //   "/Character/Ama_Shirt_St4.glb",
  //   "/Character/Ama_Hair_Hr1.glb",
  // ];

  // Daiyu GLB files

  // // "/Character/Da_Glass_Gls1.glb",
  const glbfiles = [
    "/Character/Da_Body_B1.glb",
    "/Character/Da_Pant_Pt3.glb",
    "/Character/Da_Shirt_St1.glb",
    "/Character/Da_Hair_Hr1.glb",
  ];

  // // // "/Character/Da_Glass_Gls2.glb",
  // const glbfiles = [
  //   "/Character/Da_Body_B1.glb",
  //   "/Character/Da_Pant_Pt2.glb",
  //   "/Character/Da_Shirt_St2.glb",
  //   "/Character/Da_Hair_Hr2.glb",
  // ];

  // const glbfiles = [
  //   "/Character/Da_Body_B1.glb",
  //   "/Character/Da_Pant_Pt3.glb",
  //   "/Character/Da_Shirt_St3.glb",
  //   "/Character/Da_Hair_Hr3.glb",
  // ];

  // const glbfiles = [
  //   "/Character/Da_Body_B1.glb",
  //   "/Character/Da_Pant_Pt4.glb",
  //   "/Character/Da_Shirt_St4.glb",
  //   "/Character/Da_Hair_Hr1.glb",
  // ];

  // John GLB files

  // // "/Character/Joh_Glass_Gls1.glb",
  // const glbfiles = [
  ...
  // const glbfiles = [
  //   "/Character/Joh_Beard_Br2.glb",
  //   "/Character/Joh_Glass_Gls2.glb",
  //   "/Character/Joh_Body_B1.glb",
  //   "/Character/Joh_Pant_Pt2.glb",
  //   "/Character/Joh_Shirt_St2.glb",
  //   "/Character/Joh_Hair_Hr2.glb",
  // ];

  // const glbfiles = [
  //   "/Character/Joh_Beard_Br1.glb",
  //   "/Character/Joh_Body_B1.glb",
  //   "/Character/Joh_Pant_Pt3.glb",
  //   "/Character/Joh_Shirt_St3.glb",
  //   "/Character/Joh_Hair_Hr3.glb",
  // ];

  // const glbfiles = [
  //   "/Character/Joh_Beard_Br1.glb",
  //   "/Character/Joh_Body_B1.glb",
  //   "/Character/Joh_Pant_Pt4.glb",
  //   "/Character/Joh_Shirt_St4.glb",
  //   "/Character/Joh_Hair_Hr1.glb",
  // ];
      ...
      <div className="h-full w-full flex justify-center items-center gap-x-[5rem] xl:gap-x-[2.5rem] 2xl:gap-x-[5rem] overflow-y-auto [&::-webkit-scrollbar]:w-[6px] [&::-webkit-scrollbar-track]:bg-[#d3e4ebef] [&::-webkit-scrollbar-thumb]:bg-[#3E4580] [&::-webkit-scrollbar-track]:rounded-[22px] [&::-webkit-scrollbar-thumb]:rounded-[22px]">
        ...
        <div className="h-[28rem] xl:h-[22rem] 2xl:h-[37rem] w-full relative">
          ...
          <div className="absolute inset-y-0 right-0 px-3 place-content-center">
            <div className="h-[35rem] xl:h-[21.5rem] 2xl:h-[35rem] w-[25rem] xl:w-[16rem] 2xl:w-[22rem] rounded-[10px] bg-[#FFFFFF8F]">
              <div className="h-[3rem] xl:h-[2.5rem] 2xl:h-[3rem] w-full flex justify-start items-center bg-[#131F49] text-[#FFFFFF] text-[16px] xl:text-[14px] rounded-t-[10px] px-5">
                <div className="flex flex-auto">Conversation</div>
                <div className="flex text-white">
                  <label className="relative inline-flex cursor-pointer items-center">
                    ...
                    />
                    <div className="peer flex h-8 xl:h-6 2xl:h-8 items-center gap-4 rounded-full bg-orange-600 px-2 xl:px-0.5 2xl:px-2 after:absolute after:left-1 xl:after:left-0.5 after:h-6 after:w-10 xl:after:w-10 2xl:after:w-10 after:rounded-full after:bg-white/40 after:transition-all after:content-[' '] peer-checked:bg-stone-600 peer-checked:after:translate-x-full peer-focus:outline-none  text-sm text-center text-white">
                      <span className="ml-2">
              ...
              <div className="h-[28rem] xl:h-[15rem] 2xl:h-[28rem] w-full flex justify-center items-center pr-2">
                <div className="h-full w-full ">
                  <Webcam
                    ...
                    width={1280}
                    mirrored={true}
                    className={`transition-all duration-700 ease-in-out w-full object-cover ${
                      !cameraToggle
                        ? "h-[10rem] xl:h-[7.5rem] 2xl:h-[10rem] block"
                        : "h-0 hidden"
                    }`}
                  />
                  <div
                    className={`transition-all duration-700 ease-in-out w-full pr-2 py-1.5 ${
                      !cameraToggle
                        ? "h-[18rem] xl:h-[9rem] 2xl:h-[18rem]"
                        : "h-full"
                    }`}
...
export default ConversationLayout4;
